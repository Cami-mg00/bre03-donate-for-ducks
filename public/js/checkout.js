...
const stripe = Stripe("pk_test_51O4ldcDqmfwVlfd2Ti0GOwdyctaLkU5R1cIA7OmnrIVokL6M8QeLsxhmNQ6VhUfloYP66PwJ4sdYhNn3nO4lm6RE00j0kXa0QF");
...
inputNumber.addEventListener('change', amountSelected);
...
async function handleSubmit(e) {
  ...
  const { error } = await stripe.confirmPayment({
    elements,
    confirmParams: {
      return_url: "https://huguesfroger.sites.3wa.io/BRE01/JXX/correction-donate-for-ducks/public/index.php",
    },
  });
